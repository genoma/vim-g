...
syn region scssDefinition matchgroup=cssBraces start='{' end='}' contains=cssComment,cssInclude,scssComment,scssDefinition,scssProperty,scssSelector,scssVariable,scssImport,scssExtend,@scssControl,scssWarn containedin=cssMediaBlock
...
syn match scssMixin "\k\@<!@\k\S*" nextgroup=scssMixinName skipwhite
syn match scssMixinName "[[:alnum:]_-]\+" contained
...
syn region scssMap matchgroup=cssBraces start=" \zs(" end=")" contains=scssMapKey,scssMapValue
